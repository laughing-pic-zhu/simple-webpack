...
class JsonMainTemplate extends Template {
    constructor(outputOptions) {
        ...
        this.plugin('render', (bootstrapSource, chunk, hash, moduleTemplate) => {
