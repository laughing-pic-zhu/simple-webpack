...
class JsonMainTemplate extends Template {
    constructor(props) {
        ...
        this.plugin('render', (bootstrapSource, chunk) => {
            ...
            source.add("/************************************************************************/\n");
            source.add("/******/ (");
            source.add(this.renderChunk(chunk));
            return source
        });
    }
